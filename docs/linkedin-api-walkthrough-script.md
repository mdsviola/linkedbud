...
**Actions:** 4. Click "Connect Personal LinkedIn Profile" button 5. Show the redirect to LinkedIn OAuth page (or describe it)
...
**Actions:** 6. Show returning from LinkedIn callback (or describe the flow) 7. Show the "Connect Organization Pages" button
...
**Actions:** 8. Click "Connect Organization Pages" 9. Show the organization connection flow
...
**Actions:** 3. Click on different tabs to show filtering 4. Show that posts are filtered by context
...
**Actions:** 4. Show the "Publish Target" or account selector in the modal 5. Select an organization from the dropdown 6. Optionally attach an image, document, or video 7. Click "Generate" or "Create"
...
**Actions:** 8. Show the post being created and saved as DRAFT 9. Navigate to the post detail page
...
**Actions:** 3. Show the date picker and time selector 4. Show the "Publish to Account" dropdown (Personal vs Organizations) 5. Select a date and time in the future 6. Select an organization from the dropdown 7. Click "Schedule Post"
...
**Actions:** 8. Show the post status changing to "SCHEDULED" 9. Navigate to the Scheduled Posts calendar view
...
**Actions:** 10. Show the ScheduledPostsCalendar component 11. Point out posts on different dates 12. Show the color coding for personal vs organization posts
...
**Actions:** 4. Show the publish confirmation or direct publishing 5. Show the post status changing to "PUBLISHED" 6. Show the LinkedIn post ID being stored
...
**Actions:** 7. Show a link to view the post on LinkedIn 8. Show the post metrics section appearing
...
**Actions:** 4. Navigate to the Analytics page 5. Show the context selector (All Posts, Personal, Organization tabs) 6. Show the time period selector 7. Show overview cards with aggregated metrics
...
**Actions:** 8. Show the time series chart 9. Show the engagement breakdown 10. Show the top posts table
...
**Actions:** 11. Click on a metric in the post detail page to show the chart modal 12. Show historical metric data
...
**Actions:** 4. Show the disconnect option 5. Explain what happens on disconnect
