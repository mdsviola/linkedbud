...
const competitor = getCompetitorData("magicpost")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${baseUrl}/comparison/magicpost`,
  },
};

export default function MagicPostComparisonPage() {
  const webpageSchema = generateWebPageSchema(
    competitor.seoTitle,
    competitor.seoDescription,
    `${baseUrl}/comparison/magicpost`
  );
