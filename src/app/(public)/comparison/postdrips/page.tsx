...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: competitor.seoTitle,
    description: competitor.seoDescription,
    url: `${baseUrl}/comparison/postdrips`,
    siteName: "linkedbud",
    locale: "en_US",
    type: "website",
    images: [
  ...
  alternates: {
    canonical: `${baseUrl}/comparison/postdrips`,
  },
};

export default function PostdripsComparisonPage() {
  const webpageSchema = generateWebPageSchema(
    competitor.seoTitle,
    competitor.seoDescription,
    `${baseUrl}/comparison/postdrips`
  );
