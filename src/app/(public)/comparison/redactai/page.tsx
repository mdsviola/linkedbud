...
const competitor = getCompetitorData("redactai")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${baseUrl}/comparison/redactai`,
  },
};

export default function RedactAIComparisonPage() {
  const webpageSchema = generateWebPageSchema(
    competitor.seoTitle,
    competitor.seoDescription,
    `${baseUrl}/comparison/redactai`
  );
