    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
          ...
          <li>Analyze usage patterns to improve our service quality and user experience</li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4 className="font-semibold text-slate-900 dark:text-white mb-2 mt-4">Service Providers</h4>
        <p className="mb-4">
        ...
        <h4 className="font-semibold text-slate-900 dark:text-white mb-2 mt-4">Legal Requirements</h4>
        <p className="mb-4">
        ...
        <h4 className="font-semibold text-slate-900 dark:text-white mb-2 mt-4">Business Transfers</h4>
        <p className="mb-4">
        ...
        <h4 className="font-semibold text-slate-900 dark:text-white mb-2 mt-4">With Your Consent</h4>
        <p className="mb-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
          <li><strong>Encryption:</strong> All data is encrypted in transit using HTTPS/TLS and encrypted at rest in our databases</li>
          <li><strong>Access Controls:</strong> Access to personal data is restricted to authorized personnel who need it to perform their job duties</li>
          <li><strong>Authentication:</strong> Secure authentication mechanisms protect your account</li>
          <li><strong>Regular Security Reviews:</strong> We conduct regular security assessments and updates</li>
          <li><strong>Infrastructure:</strong> We rely on trusted cloud providers with strong security practices</li>
        </ul>
        <p className="mb-4 text-xs text-slate-500 dark:text-slate-400">
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
          ...
          <li><strong>Content Data:</strong> Retained while your account is active. You can delete your content at any time</li>
          <li><strong>Third-Party Service Data:</strong> Deleted immediately upon disconnection of the third-party service or account deletion</li>
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
          ...
          <li>Notify you of material changes by email or through a prominent notice in our service</li>
        ...
        <section className="pb-20">
          <div className="mx-auto max-w-4xl space-y-8 px-6 lg:px-8">
            {sections.map((section) => (
              <div key={section.title} className="rounded-3xl border border-slate-200/70 bg-white/80 p-8 text-left text-sm leading-relaxed text-slate-600 shadow-sm backdrop-blur dark:border-slate-800/70 dark:bg-slate-900/60 dark:text-slate-300">
            ...
            <div className="rounded-3xl border border-blue-200/70 bg-blue-50/80 p-8 text-left text-sm leading-relaxed text-slate-600 shadow-sm backdrop-blur dark:border-blue-800/70 dark:bg-blue-900/20">
              ...
              <p className="mb-4 text-xs text-slate-500 dark:text-slate-400">
                <strong>What We Don&apos;t Collect:</strong> We do not collect or process private messages, connection lists for marketing purposes, or email addresses for lead generation.
              </p>
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                <li><strong>Providing Services:</strong> To enable content creation, scheduling, publishing, and analytics features you request (Legal Basis: Performance of a contract — GDPR Article 6(1)(b))</li>
                <li><strong>Improving Services:</strong> To maintain and improve the reliability and security of our LinkedIn integration (Legal Basis: Legitimate interests — GDPR Article 6(1)(f))</li>
                <li><strong>Legal Compliance:</strong> To comply with legal obligations and respond to data subject requests (Legal Basis: Legal obligation — GDPR Article 6(1)(c))</li>
              </ul>
              <p className="mb-4 text-xs text-slate-500 dark:text-slate-400">
                We do not use LinkedIn data for profiling unrelated to service provision, advertising, or lead generation.
              </p>
              ...
              <p className="mb-2">
                <strong>Storage:</strong> All LinkedIn-related data is stored in Supabase (PostgreSQL) with encryption at rest. All API communication uses HTTPS/TLS encryption in transit. Access tokens and LinkedIn identifiers are stored server-side only, never in client-side code.
              </p>
              <p className="mb-4">
                <strong>Retention:</strong> Access tokens are retained while your LinkedIn integration is active, and deleted immediately upon disconnect or account deletion. Organization data is retained while your organization integration is active. Post IDs and aggregated metrics are retained to provide analytics while your account is active, and deleted upon account deletion or upon your request. Draft content is retained while your account is active, and deleted upon account deletion or upon your request.
              </p>
              ...
              <p className="mb-4">
                We do not sell LinkedIn data. We share LinkedIn data only with our service providers (hosting and infrastructure providers like Supabase and Vercel) who process it on our behalf under data processing agreements and appropriate safeguards. If your data is transferred internationally, such transfers are safeguarded by standard contractual clauses or equivalent mechanisms.
              </p>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Full legal terms are available upon request. Email privacy@linkedbud.com for detailed documentation.
            </p>
          </div>
        </section>
      </div>
